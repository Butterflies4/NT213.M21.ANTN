...
urlpatterns = [
     ...
     path('dashboard/DongGopTL/', views.DongGopTL_view, name='DongGopTL_view'), path('dashboard/TaiLieu/', views.TaiLieu_view, name='TaiLieu_view'),
     ...
     path('dashboard/profile/', views.ThongTinCaNhan_view, name='ThongTinCaNhan_view'),
     path('profile/<slug:username>/', views.show_profile_public, name='show_profile'),
     ...
     path('subjects/<slug:MaMH>/',views.save_comment,name='save-comment'),
